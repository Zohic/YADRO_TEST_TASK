...
Код для этой задачи находится в [main.cpp](./src/test_accuracy)

# Патчи

После дедлайна были добавлены изменения в репозиторий  
[Версия репозитория в день дедлайна доступна](https://github.com/Zohic/YADRO_TEST_TASK/tree/9ceff7c44d50776ed6da2e76bce69d9ac781fae1)
